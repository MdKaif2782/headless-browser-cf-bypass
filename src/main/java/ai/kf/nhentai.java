...
//        System.out.println(driver.getPageSource());
        ...
        String userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.76";
        Map<String, String> cookies = new HashMap<>();
        cookies.put("cf_clearance", "PqmuRdbdEyBSgRCA2NKUCO.b6V.TJxQOMXnPhD_a29c-1698918671-0-1-4afeafd0.6547d2f0.1dfff030-160.0.0");
...
//        cookies.put("sessionid","8zg3txpfo2eaymy51brdpkelpmlsmb9a");
        ...
        try (NHentaiClient nhentaiClient = new NHentaiClient(userAgent, cookies)) {
            ...
            nhentaiClient.getDoujin(177013);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
